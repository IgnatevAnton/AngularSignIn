...
export class UserFollowersBarComponent {
  ...
  private _isInitialFollowersData: boolean = false;
  ...
  constructor(
    ...
    @Inject(ApplicationTokens.SettingInterfaceServiceToken) settingInterfaceService: ApplicationServices.ISettingInterfaceService,
  ) {
    ...
    effect(() => {
      ...
      if (isVisible === undefined || isVisible === this._isInitialFollowersData) { return; }
