...
export class FollowersService implements IFollowersService {
  ...
  get isLoadingFollowers$(): Signal<boolean> {
    return this._isLoadingFollowers.asReadonly();
  }
  get isErrorFollowers$(): Signal<boolean> {
    return this._isErrorFollowers.asReadonly();
  }
